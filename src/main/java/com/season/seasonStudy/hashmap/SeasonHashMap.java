...
//public class SeasonHashMap<K,V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable {
public class SeasonHashMap<K, V> {
...
//                // Map.Entry<K, V> entry = (Map.Entry<K, V>)o; // 数据类型不一样怎么办，数据类型一个是Object，一个是Integer
